...
$translations = [
    ...
    "PUBLISHER_ADD_HTMLTITLE" 	=> "Přidat vydavatele",
    "PUBLISHER_ADD_TITLE" 		=> "Titul",
    "PUBLISHER_ADD_ADDRESS" 	=> "Adresa",

    "AUTHOR_ADD_HTMLTITLE" 		=> "Přidat authora",
    "AUTHOR_ADD_FIRST_NAME" 	=> "Křestní jméno",
    "AUTHOR_ADD_LAST_NAME" 		=> "Příjmení",
