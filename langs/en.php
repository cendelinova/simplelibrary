...
$translations = [
    ...
    "AUTHOR_ADD_FIRST_NAME" 	=> "First name",
    "AUTHOR_ADD_LAST_NAME" 		=> "Last name",
    ...
    "AGERANGE_ADD_HTMLTITLE"    => "Add range",
    "AGERANGE_ADD_TITLE"        => "Title",
    "AGERANGE_ADD_YEARS_FROM"   => "Years from",
    "AGERANGE_ADD_YEARS_TO"     => "Years to",
